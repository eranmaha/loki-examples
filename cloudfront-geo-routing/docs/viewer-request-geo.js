...
async function handler(event) {
  ...
  // Get viewer country from CloudFront header (or test header)
  ...
  // Check if the target origin is enabled (maintenance mode)
  if (originId) {
  ...
  // Pass routing metadata to origin
